<template>
  <!--
    ...
    ```
  -->
  <div class="flex min-h-full items-center justify-center rounded px-8 py-16 sm:px-6 lg:px-12">
    <div class="w-full max-w-md space-y-8">
      <div>
        <img class="mx-auto h-12 w-auto" src="/logos/lazy-lab-logos_black_full.png" alt="Your Company" />
